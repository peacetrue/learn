package com.github.peacetrue.learn.swagger;
...
public class DubboReader implements OpenApiReader {
    private static final Logger LOGGER = LoggerFactory.getLogger(DubboReader.class);
    ...
    public DubboReader(OpenAPI openAPI) {
        this();
        setConfiguration(new SwaggerConfiguration().openAPI(openAPI));
    }

    public DubboReader(OpenAPIConfiguration openApiConfiguration) {
        this();
